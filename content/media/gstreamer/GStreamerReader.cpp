...
#ifdef HAS_NEMO_RESOURCE // FIXME we should find better way to detect nemo environment
                                         ...
                                         int64_t aTimeThreshold)
{
  ...
  if (GStreamerGLHelper::GetHandleBuffer(buffer) != nullptr)
  {
    SharedTextureHandle handle =
      gl::GLContextProvider::CreateSharedHandle(gl::SameProcess,
                                                (void*)buffer,
